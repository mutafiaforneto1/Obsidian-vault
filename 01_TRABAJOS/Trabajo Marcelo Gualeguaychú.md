...
# 📦 Materiales
- 🎥 5 metros de cable tipo taller de 3x1,5mm.
- 10 metros cable de 1,5mm.
- 2 fotocélulas.
- 💡2 dicroicas .
- bastidores.
- 5 metros de cable tipo taller de 3x1,5mm (🌲 parrilla).
- llave de un punto y toma encapsulado para intemperie ⛈️ (🌲 parrilla).
- 2 cajas estancos de 10x10
- dos módulos de toma jelux
- poximix
